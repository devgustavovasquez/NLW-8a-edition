...
import { ScreenschotButton } from "../ScreenshotButton"
...
export const FeedbackContentStep = ({
  ...
  const feeedbackTypeInfo = feedbackTypes[feedbackReceived]
  ...
  return (
    ...
    <header>
      ...
      <span className="text-xl leading-6 flex items-center gap-2">
        <img src={feeedbackTypeInfo.image.source} alt={feeedbackTypeInfo.image.alt} className="w-6 h-6"/>
